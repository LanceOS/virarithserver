...
<section class="space-y-3">
	...
	<div class="input p-3">
		<div class="mb-1 flex items-center gap-2">
			...
			<span class="text-sm font-medium text-[var(--color-muted)]">Minecraft</span>
		</div>
		{#if isEditing}
			<input
				type="text"
			...
			/>
		{:else}
			<p class="text-sm text-[var(--color-base-content)] text-left">
	...
	<div class="input p-3">
		<div class="mb-1 flex gap-2">
			...
			<span class="text-sm font-medium text-[var(--color-muted)]">Discord</span>
		</div>
		{#if isEditing}
			<input
				type="text"
			...
			/>
		{:else}
			<p class="text-left text-sm text-[var(--color-base-content)]">
